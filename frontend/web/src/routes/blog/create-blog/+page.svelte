...
<body class="lg:flex lg:flex-row justify-center items-center w-screen h-screen ">
    ...
    <div class="flex flex-col justify-center items-center lg:relative lg:translate-x-0 lg:left-0 lg:top-auto lg:w-1/2 absolute left-1/2 -translate-x-1/2  sm:w-[600px] top-0">
...
<style>
    ...
    #bgimg_up{
        ...
        background-image: url("../../../assets/tumblr_n5tuyw0G8S1tah9pwo8_r1_640.gif");
