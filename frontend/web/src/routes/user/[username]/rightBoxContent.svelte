...
<div class="flex items-center gap-[8px] py-2 overflow-x-scroll min-h-[90px]">
    ...
    {:else}
        {#if instagram}
        <Socialslist title={"Instagram"} socialId={instagram} imagePath={"/src/routes/user/assets/instagram_logo.png"}></Socialslist>
        {/if}
        {#if facebook}
        <Socialslist title={"Facebook"} socialId={facebook} imagePath={"/src/routes/user/assets/facebook_logo.png"}></Socialslist>
        {/if}
        {#if github}
        <Socialslist title={"Github"} socialId={github} imagePath={"/src/routes/user/assets/github_logo.png"}></Socialslist>
        {/if}
        {#if linkedin}
