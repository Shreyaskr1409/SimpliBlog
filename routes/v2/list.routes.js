...
import {addToList, createList, deleteList, editListDescription, getList, getUserLists} from "../../controllers/list.controllers.js";
...
router.route("/edit-list-description").post(verifyJWT, editListDescription)
